...
function mostrarFeedback(){
    ...
    document.getElementById('feedback').innerHTML = "Gracias " + nombre + " " + apellido + " " + "se le enviara una guia de como usar el template elegido a" + " " + email + " " + "y continuar con su proyecto";
